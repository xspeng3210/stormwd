...
public class ZooKeeperx extends ZkConnection {
    ...
    private static final Field  zookeeperField=ReflectionUtils.findField(ZkConnection.class,"_zk");
	...
	public void connect(Watcher watcher){
	    ...
	    ZooKeeper _zk=(ZooKeeper)ReflectionUtils.getField(zookeeperField, this);
	    ...
	    try{
	    	...
	    	try{
	    		...
	    		ReflectionUtils.setField(zookeeperField, this, _zk);
	    	}catch(IOException e){
